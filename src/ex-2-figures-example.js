...
function main() {
  ...
  // Torus Knot
  {
    ...
    const MERIDIAN_WRAP = 2; // Number of times it wraps around the torus' meridian
    const EQUATOR_WRAP = 4; // Number of times it wraps around the torus' equator
    addSolidGeometry(1, -0.5, new THREE.TorusKnotGeometry(RADIUS, TUBE, TUBULAR_SEGMENTS, RADIAL_SEGMENTS, MERIDIAN_WRAP, EQUATOR_WRAP));
  }
